...
BQ="http://upload.sat-universum.de/enigma2jodasa.tar.gz"
#BP="http://upload.sat-universum.de/Setings_jodasa.tar.gz"

## Bouquet Download, Installation + Reload ##
cd /tmp/
wget $BQ
chmod 755 /tmp/enigma2jodasa.tar.gz
/sbin/tar -xzvf enigma2jodasa.tar.gz
...
rm -rf /tmp/enigma2
rm -rf /tmp/enigma2jodasa.tar.gz
